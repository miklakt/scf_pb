...
# %%
scf_pb.free_energy_external(phi=phi, chi=0.0, chi_PC=-1.0, a0=0.18, a1=-0.09, particle_width=4, particle_height=4, z=10)
# %%
scf_pb.D_eff_external(phi=phi, chi=0.0, chi_PC=-1.0, a0=0.18, a1=-0.09, particle_width=4, particle_height=4, a=2, b = D-2, k_smooth =4)
# %%
